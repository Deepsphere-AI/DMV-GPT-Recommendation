...
def All_Initialization():
    ...
    st.image(image)
    st.markdown("<h1 style='text-align: center; color: #454545; font-size:25px;'>DMV ChatGPT Application</h1><h2 style='text-align: center; color: blue; font-size:20px;'>GPT Simplifies the Prediction of Profanity Categories and Recommendation</h2>", unsafe_allow_html=True)
    st.markdown("""
    ...
    choice3 =  st.sidebar.selectbox(" ",('Models Used','ChatGPT(GPT-3.5-turbo)', 'GPT3 - Davinci','GPT3 - Ada','GPT3 - Babbage','GPT3 - Curie'))
